$(document).ready(function() {
    ...
    $("#navbar-placeholder").load("navbar.html", function() {
        ...
        if (page.endsWith("index.html") || page === "") {
             // ensure we match regardless of leading slash
             // actually the hrefs are "index.html", "shop.html" etc.
        }
        ...
        var $link = $('.main-menu ul li a').filter(function() {
             ...
             // Compare purely on filename
             return href === page || (href === 'index.html' && (page === '' || page === 'index.html'));
        });
